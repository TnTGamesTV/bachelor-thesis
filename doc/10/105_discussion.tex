...
Dabei wird zuerst auf die erarbeitete Anwendung, die verschiedenen Stufen der Schaffungsprozesses und das Konzept eingegangen.
...
sowie die Verwendung mehrerer Modelle als gleichzeitige Datenquelle technisch nicht realisieren waren. \\
...
Das \gls{llm} konnte grundsätzlich komplexe Anfragen verstehen, zeigte jedoch Lücken in der korrekten Verwendung der bereitgestellten Werkzeuge, insbesondere im Bezug auf die Datenbankabfrage sowie in der Interpretation von Datenbankstrukturen.
...
Im Rahmen der Interviews konnte der entwickelte Prototyp erfolgreich eingesetzt werden und die Kombination aus \gls{llm} und menschlicher Interpretation im Kontext von digitalen, datengetriebenen Bauprojekten untersucht werden können.
...
dass die Nutzung von \gls{llm}, für fachfremden Akteuren den Zugang zu digitalen, datengetriebenen Bauprojekten zu ermöglichen, umsetzbar ist.
