...
\end{tikzpicture}
\caption[Fehlerergebnisse der \gls{llm}-Auswertung]{Bei den analysierten Fehlern des \gls{llm} wurden 9.5\% der Fehler durch die Nutzung einer falschen IFC-Entität verursacht, 23.8\% durch die Nutzung einer falschen Property oder Pset, 14.3\% durch die Nutzung eines falschen Werkzeugs, 23.8\% durch falsch aufgebaute SQL-Abfragen, und 28.6\% durch sonstige Fehler.}
