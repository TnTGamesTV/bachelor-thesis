...
\end{tikzpicture}
\caption[Gesamtergebnisse der \gls{llm}-Auswertung]{Verteilung der Ergebnisse (gesamt: 41)}
...
\end{tikzpicture}
\caption[Fehlerergebnisse der \gls{llm}-Auswertung]{Verteilung der Fehlertypen (gesamt: 21)}
