...
Auf Basis der nach der Entwicklung des Prototypen des verfeinerten Entwicklungsplans wurde der lauffähige Prototyp entwickelt. 
...
Aufgrund der generischen Natur wird diese in der Praxis auch an Stellen eingesetzt, für die im \gls{ifc}-Standard bereits eine Passende vorgegeben ist.
...
Im Rahmen der Vorprüfung der Aufgabenstellungen wurden diese aussortiert, da sie mehrere Aufgaben in Einer vereinten,
...
jedoch wurde des Öfteren die Annahme getroffen, dass Properties in allen Modellen vorhanden waren, obwohl dies, besonders in Fachmodellen, nicht gegeben war. \\
