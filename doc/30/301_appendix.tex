...
\appendixentry{Antworten der Probanden auf Zuordnungsfragen}
...
\appendixentry{Vollständige Analyse der \gls{llm}-Ausgaben}
...
\appendixentry{Aufgabenstellungen der Probandengruppe A}
...
\begin{enumerate}
    ...
    \item Vergleichen Sie, ob alle Ebenen (IfcBuildingStorey) in den Modellen gleich benannt werden und die gleiche Höhe besitzen.
