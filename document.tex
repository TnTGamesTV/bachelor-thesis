...
\documentclass[oneside,openright,11pt,a4paper]{scrreprt}
...
\include{doc/00/000_abbreviations}
...
\usepackage[left=5.0cm,right=2.0cm,top=2.0cm,bottom=2.0cm]{geometry}
...
\ifoot[]{}
\cfoot[]{}
\ofoot*{\centering\vspace{1cm}\pagemark} 
...
% German names for figures/tables and their lists
...
\begin{document}
    ...
    \include{./doc/20/201_abbrevations}
    \clearpage
    ...
    %acknowledgments 
     \clearpage
    \markright{\textbf{Danksagungen}}
    \markleft{\textbf{Danksagungen}}
    \include{./doc/20/202_acknowledgements}
