...
\hyphenation{Web-So-ckets}
\hyphenation{Ifc-Buil-ding-E-le-ment-Pro-xy}
...
\usepackage[main=german,english]{babel}       % language: german and english, german is main language; use local switch for english sections
